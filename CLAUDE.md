...
## Key decisions
- [2026-07-23] Brand color changed from Fresh Jobs chartreuse to light orange (oklch hue ~60, "orange juice"), across primary/ring/icon/PWA theme colors — reverses the earlier match-fresh-jobs-palette decision; layout, Geist fonts, and flat style still follow BRANDING.md.
